...
class AddTaskBottomSheetProjects extends StatelessWidget {
  int project_id;
  AddTaskBottomSheetProjects({Key? key, required this.project_id})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BottomSheet(project_id: project_id),
    );
  }
}
...
class BottomSheet extends StatelessWidget {
  int project_id;
  BottomSheet({Key? key, required this.project_id}) : super(key: key);
