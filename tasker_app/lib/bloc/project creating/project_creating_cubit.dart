...
final ProjectRepository repository;
  ProjectCreatingCubit({required this.repository}) : super(ProjectCreatingInitial(data: Project()));

  void updateTitle(String title) {
    final currentState = state;
    if (currentState is ProjectCreatingDataChanged || currentState is ProjectCreatingInitial) {
      emit(ProjectCreatingDataChanged(data: currentState.data.copyWith(title: title)));
    }
  }
